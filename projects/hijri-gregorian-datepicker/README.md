...
| <b>`selectionMode`</b>             | string  |                   `single`                    | Date selection mode: `single` for single date, `multiple` for multiple dates, or `range` for date range          |
...
| <b>`selectionMode`</b>             | string  |                   `single`                    | Date selection mode: `single` for single date, `multiple` for multiple dates, or `range` for date range selection |
